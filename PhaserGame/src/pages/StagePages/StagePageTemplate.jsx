...
export default function StagePage() {
  return (
    ...
    <div className="relative z-20 max-w-7xl mx-auto px-4 lg:px-8 py-16">
        ...
        <li className="text-white font-medium min-w-0">Stage name 01</li>
        </ol>
    ...
    <div className="max-w-7xl mx-auto py-4 px-4 lg:px-8 pb-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                ...
                <div className="h-32 bg-gray-50 border border-gray-200 rounded-lg flex items-center justify-center text-gray-400">
                Placeholder for stage info
                </div>
            </div>
